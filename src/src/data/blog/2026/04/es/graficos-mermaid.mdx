...
<a href="https://mermaid.js.org/" target="_blank">Mermaid</a> es un lenguaje de
marcado que permite crear gráficos de forma declarativa, usando una
<a href="https://github.com/mermaid-js/mermaid" target="_blank">librería de
código abierto</a> de JavaScript para generar las gráficas.

Mermaid fue creado por Knut Sveidqvist, quien se <a href="https://github.com/mermaid-js/mermaid/issues/1904" target="_blank">inspiró</a>
...
base de usuarios masiva, superando las 87.500 estrellas en GitHub.
...
[NLP](/es/posts/2026/04/glosario-linguistica-nlp).
...
<a href="https://astro-mermaid-demo.netlify.app/" target="_blank">Aquí</a> puedes ver más ejemplos.
