...
4. Clic Continue to summary → Create Token.
...
6. El nuevo token puede ser probado:
...
Esto abre un browser para OAuth. Personalmente esto no me gusta.
...
7. Probar el worker, que quedará en
