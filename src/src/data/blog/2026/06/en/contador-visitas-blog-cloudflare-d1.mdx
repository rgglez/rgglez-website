...
The operation is similar to the one described in <a href="/en/posts/2026/04/deploy-sveltekit-cloudflare-workers/">this post</a> about deploying SvelteKit on Cloudflare.
