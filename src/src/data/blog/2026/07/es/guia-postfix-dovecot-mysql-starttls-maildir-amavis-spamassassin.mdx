...
|---|---|---|
| Postfix | MTA: recibe, enruta y entrega correo SMTP | <a href="https://www.postfix.org/" target="_blank">postfix.org</a> |
| Dovecot | Servidor IMAP/POP3/LMTP y proveedor SASL | <a href="https://www.dovecot.org/" target="_blank">dovecot.org</a> |
| MySQL | Base de datos de dominios, buzones, alias y políticas | <a href="https://www.mysql.com/" target="_blank">mysql.com</a> |
| MariaDB | Alternativa compatible a MySQL | <a href="https://mariadb.org/" target="_blank">mariadb.org</a> |
| Amavis (amavisd-new) | Filtro de contenido entre Postfix y los motores antivirus/antispam | <a href="https://gitlab.com/amavis/amavis" target="_blank">gitlab.com/amavis/amavis</a> |
| SpamAssassin | Motor antispam | <a href="https://spamassassin.apache.org/" target="_blank">spamassassin.apache.org</a> |
| ClamAV (`clamd`) | Motor antivirus invocado por Amavis | <a href="https://www.clamav.net/" target="_blank">clamav.net</a> |
| MaxMind GeoLite2 | Base de datos GeoIP para el control por país | <a href="https://www.maxmind.com/en/geoip-databases" target="_blank">maxmind.com</a> |
| Let's Encrypt / Certbot | Emisión de certificados TLS para STARTTLS | <a href="https://certbot.eff.org/" target="_blank">certbot.eff.org</a> |
| Python 3 | Runtime del policy daemon (rate limit + GeoIP) | <a href="https://www.python.org/" target="_blank">python.org</a> |
