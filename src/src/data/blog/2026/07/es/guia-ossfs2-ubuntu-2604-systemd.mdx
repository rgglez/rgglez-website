...
Repite el patrón con `/etc/ossfs2/multimedia.env`, `/etc/ossfs2/respaldos.env` u otros nombres. Cada instancia debe tener punto de montaje y directorio de logs propios.
