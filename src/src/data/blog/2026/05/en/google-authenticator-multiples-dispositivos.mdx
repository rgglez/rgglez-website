...
1. [Basic concepts: what you are really protecting](#1-basic-concepts-what-you-are-really-protecting)
2. [Mental model: password, second factor, and TOTP seed](#2-mental-model-password-second-factor-and-totp-seed)
3. [Possible strategies](#3-possible-strategies)
4. [Recommended setup for a technical user](#4-recommended-setup-for-a-technical-user)
5. [Step-by-step procedure: Google Authenticator on two devices](#5-step-by-step-procedure-google-authenticator-on-two-devices)
6. [Recommended procedure by account type](#6-recommended-procedure-by-account-type)
7. [Backup codes: the piece many people ignore](#7-backup-codes-the-piece-many-people-ignore)
8. [The Google account as a critical point](#8-the-google-account-as-a-critical-point)
9. [Risks of having Authenticator on multiple devices](#9-risks-of-having-authenticator-on-multiple-devices)
10. [What to do if you already lost your phone](#10-what-to-do-if-you-already-lost-your-phone)
11. [Personal audit procedure](#11-personal-audit-procedure)
12. [Recommendation for maximum-criticality accounts: FIDO2/WebAuthn](#12-recommendation-for-maximum-criticality-accounts-fido2webauthn)
13. [Initial setup checklist](#13-initial-setup-checklist)
14. [Biannual maintenance checklist](#14-biannual-maintenance-checklist)
15. [Frequently asked questions](#15-frequently-asked-questions)
16. [Final recommended procedure](#16-final-recommended-procedure)
