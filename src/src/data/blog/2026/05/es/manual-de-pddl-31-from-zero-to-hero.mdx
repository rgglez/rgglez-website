...
- Ghallab, M., Howe, A., Knoblock, C., McDermott, D., Ram, A., Veloso, M., Weld, D., & Wilkins, D. (1998). *PDDL—The Planning Domain Definition Language, Version 1.2*.
...
- Kovács, D. L. (2011). *Complete BNF Description of PDDL 3.1*.
- IPC 2008 deterministic track. *Changes in PDDL 3.1*.
- Planning Wiki. *PDDL reference and guide*.
